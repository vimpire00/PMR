...
//    py::bind_vector<std::vector<std::string>>(m, "VectorStr", py::buffer_protocol());
    ...
    */
    ...
    m.def("vectordot", &vectordot, "Vector scalar dot");
    ...
    m.def("sum_v", &sum_v, "Multiplies the Inputs according to y = Wx");
    ...
    */
    ...
    m.def("client_precomputation_szy", &client_precomputation_szy, "Client precomputation according to MiniONN. Takes encrypted w, r, and v and returns U");
    m.def("client_chamlon", &client_chamlon, "Client precomputation according to MiniONN. Takes encrypted w, r, and v and returns U");
