...
class Parser11:
    ...
    def set_arguments(self):
        ...
        self.parser.add_argument('--load-model', type=str, default='szysaved_model_max_recall_ba58_ba20_ep10000.pt',
                                 help='base path for loading encoders, cross-modal space, etc.')
...
class Parser21:
    ...
    def set_arguments(self):
        ...
        self.parser.add_argument('--load-path', type=str, default='./',
                                 help='base path for loading encoders, cross-modal space, etc.')
        # self.parser.add_argument('--load-model', type=str, default=None,
        self.parser.add_argument('--load-model', type=str, default='szysaved_model_max_recall_ba58_ba20_emb256_lr4.pt',
                                 help='base path for loading encoders, cross-modal space, etc.')
        self.parser.add_argument('--n_epochs', type=int, default=10000,
                                 help='base path for loading encoders, cross-modal space, etc.')
...
class Parser31:
    ...
    def set_arguments(self):
        ...
        self.parser.add_argument('--load-path', type=str, default='./',
                                 help='base path for loading encoders, cross-modal space, etc.')
        # self.parser.add_argument('--load-model', type=str, default=None,
        self.parser.add_argument('--load-model', type=str, default='szysaved_model_max_recall_ba58_ba20_lr4_emb512.pt',
                                 help='base path for loading encoders, cross-modal space, etc.')
        self.parser.add_argument('--n_epochs', type=int, default=10000,
                                 help='base path for loading encoders, cross-modal space, etc.')
